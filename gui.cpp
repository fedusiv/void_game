...
void Gui::updatePlayerInfo(int **stats, int level, QString raceName, QString className, int step, float health)
{
    mainWindow->updatePlayerInfo(stats,level,raceName,className,step,health);
}
